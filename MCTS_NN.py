...
class MCTS_Node():
    ...
    def __init__(self, gamestate, model, parent=None, parent_action=None):
    ...
    def expand(self):
        ...
        child_node = MCTS_Node(next_state, self.NNmodel, parent=self, parent_action=action)
